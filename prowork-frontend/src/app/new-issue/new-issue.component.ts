...
export class NewIssueComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.issueService.getAllProjects().subscribe(
      (projects: Project[]) => {
  ...
  onSubmit() {
    ...
    formData.set('project', formValue.project);
